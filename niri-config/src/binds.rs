...
pub enum Action {
    ...
    FocusSpatialUp,
    FocusSpatialDown,
    PanCamera(#[knuffel(argument)] f64, #[knuffel(argument)] f64),
    ZoomCanvas(#[knuffel(argument)] f64),
...
impl From<niri_ipc::Action> for Action {
    fn from(value: niri_ipc::Action) -> Self {
        match value {
            ...
            niri_ipc::Action::FocusSpatialLeft {} => Self::FocusSpatialLeft,
            niri_ipc::Action::FocusSpatialRight {} => Self::FocusSpatialRight,
            niri_ipc::Action::FocusSpatialUp {} => Self::FocusSpatialUp,
            niri_ipc::Action::FocusSpatialDown {} => Self::FocusSpatialDown,
            niri_ipc::Action::PanCamera { dx, dy } => Self::PanCamera(dx, dy),
            niri_ipc::Action::ZoomCanvas { factor } => Self::ZoomCanvas(factor),
            ...
            niri_ipc::Action::ToggleCanvasMode {} => Self::ToggleCanvasMode,
